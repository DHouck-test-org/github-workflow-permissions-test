...
Let's test GH Actions security
...
running in the background. If you've already built symlinks, your up-to-date script can be run instantly by entering `github-workflow-permissions-test` into the KoLmafia CLI.
